...
class PharmacyApp:
    def __init__(self, root):
        ...
        self.label_name = ttk.Label(root, text="İlaç Adı:", background='#e6f2ff')
        self.label_name.grid(row=0, column=0, padx=10, pady=5)
        
        self.entry_name = ttk.Entry(root)
        self.entry_name.grid(row=0, column=1, padx=10, pady=5)
        
        self.label_price = ttk.Label(root, text="Fiyat:", background='#e6f2ff')
        ...
        self.label_quantity = ttk.Label(root, text="Adet:", background='#e6f2ff')
        ...
        self.label_buyer = ttk.Label(root, text="Satın Alan:", background='#e6f2ff')
        ...
        self.label_avg_price = ttk.Label(root, text="Ortalama Fiyat (İnternet):", background='#e6f2ff')
